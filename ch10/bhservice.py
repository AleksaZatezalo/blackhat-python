"""
Description: A set of services made to emmulate a vulnerable windows system.
...
class BHServerSvc(win32serviceutil.ServiceFramework):
    ...
    _svc_description_ = ("Executes VBScripts at regular intervals." + " What could go wrong?")
